...
Current phone build: **1.8.80 (177)**, with queue and stream-message repairs.
Apple accepted its upload; TestFlight distribution is being checked. The App
Store candidate remains **1.8.79 (176)**, Waiting for Review. The verified server runs bridge 0.1.10 and all five compatibility
